      ...
      <div className=" mx-auto  flex flex-col-reverse md:flex-row items-start justify-between gap-12">
        ...
        <div className="flex-1">
          ...
          <p className=" text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-10 max-w-xl leading-relaxed">
            ...
            responsive, and user-centered web applications using React.js ,
            Next.js and Tailwind CSS. Currently studying Computer Science and
            actively developing real-world projects while seeking internship
